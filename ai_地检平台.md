...
2026-07-15 03:31:43.858 |  |  |  | 29520-156a10 | ERROR    | module_admin.service.log_service:consume_stream:464 - 日志聚合消费异常: Error while reading from 192.168.100.100:16379 : (10054, '远程主机强迫关闭了一个现有的连接。', None, 10054, None)
2026-07-15 03:31:43.859 |  |  |  | 29520-156a10 | ERROR    | module_payload.service.payload_telemetry_archive_service:_worker_loop:140 - 遥测归档队列读取失败
Traceback (most recent call last):
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\connection.py", line 607, in read_response
    ...
    ^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\_parsers\resp2.py", line 82, in read_response
    response = await self._read_response(disable_decoding=disable_decoding)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\_parsers\resp2.py", line 90, in _read_response
    raw = await self._readline()
          ^^^^^^^^^^^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\_parsers\base.py", line 468, in _readline
    data = await self._stream.readline()
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "D:\tools\Python\Lib\asyncio\streams.py", line 562, in readline
    line = await self.readuntil(sep)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "D:\tools\Python\Lib\asyncio\streams.py", line 677, in readuntil
    await self._wait_for_data('readuntil')
  File "D:\tools\Python\Lib\asyncio\streams.py", line 539, in _wait_for_data
    await self._waiter
  File "D:\tools\Python\Lib\asyncio\selector_events.py", line 1009, in _read_ready__data_received
...
Traceback (most recent call last):
  File "E:\plat\PayloadGroundTest\ruoyi-fastapi-backend\module_payload\service\payload_telemetry_archive_service.py", line 134, in _worker_loop
    item = await redis.brpop(rk.archive_queue_key(), timeout=1)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\client.py", line 725, in execute_command
    return await conn.retry.call_with_retry(
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...<4 lines>...
    )
    ^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\retry.py", line 55, in call_with_retry
    raise error
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\retry.py", line 50, in call_with_retry
    return await do()
           ^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\client.py", line 700, in _send_command_parse_response
    return await self.parse_response(conn, command_name, **options)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\client.py", line 746, in parse_response
    response = await connection.read_response()
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\connection.py", line 621, in read_response
    raise ConnectionError(f"Error while reading from {host_error} : {e.args}")
redis.exceptions.ConnectionError: Error while reading from 192.168.100.100:16379 : (10054, '远程主机强迫关闭了一个现有的连接。', None, 10054, None)
2026-07-15 08:03:45.555 |  |  |  | 29520-156a10 | ERROR    | module_payload.service.payload_telemetry_archive_service:_worker_loop:140 - 遥测归档队列读取失败
Traceback (most recent call last):
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\connection.py", line 607, in read_response
    response = await self._parser.read_response(
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Traceback (most recent call last):
  ...
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\redis\asyncio\connection.py", line 621, in read_response
    raise ConnectionError(f"Error while reading from {host_error} : {e.args}")
redis.exceptions.ConnectionError: Error while reading from 192.168.100.100:16379 : (10054, '远程主机强迫关闭了一个现有的连接。', None, 10054, None)
2026-07-15 08:03:45.564 |  |  |  | 29520-156a10 | WARNING  | config.get_scheduler:on_lock_lost:273 - ⚠️ Worker 29520-156a10 失去 Application 锁
2026-07-15 08:03:45.565 |  |  |  | 29520-156a10 | ERROR    | logging:callHandlers:1737 - Exception closing connection <AdaptedConnection <asyncmy.connection.Connection object at 0x000001F826E642D0>>
Traceback (most recent call last):
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\sqlalchemy\pool\base.py", line 374, in _close_connection
    self._dialect.do_close(connection)
    ~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\sqlalchemy\engine\default.py", line 721, in do_close
    dbapi_connection.close()
    ~~~~~~~~~~~~~~~~~~~~~~^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\sqlalchemy\dialects\mysql\asyncmy.py", line 114, in close
    self.await_(self._connection.ensure_closed())
    ~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\sqlalchemy\util\_concurrency_py3k.py", line 132, in await_only
    return current.parent.switch(awaitable)  # type: ignore[no-any-return,attr-defined] # noqa: E501
           ~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^
  File "e:\plat\PayloadGroundTest\ruoyi-fastapi-backend\venv\Lib\site-packages\sqlalchemy\util\_concurrency_py3k.py", line 196, in greenlet_spawn
    value = await result
            ^^^^^^^^^^^^
  File "asyncmy/connection.pyx", line 365, in ensure_closed
  File "D:\tools\Python\Lib\asyncio\streams.py", line 374, in drain
    raise exc
  File "D:\tools\Python\Lib\asyncio\selector_events.py", line 1009, in _read_ready__data_received
    data = self._sock.recv(self.max_size)
ConnectionResetError: [WinError 10054] 远程主机强迫关闭了一个现有的连接。
2026-07-15 08:03:45.687 |  |  |  | 29520-156a10 | ERROR    | module_admin.service.log_service:consume_stream:464 - 日志聚合消费异常: Error while reading from 192.168.100.100:16379 : (10054, '远程主机强迫关闭了一个现有的连接。', None, 10054, None)
2026-07-15 08:03:45.688 |  |  |  | 29520-156a10 | INFO     | logging:callHandlers:1737 - Scheduler has been shut down
2026-07-15 08:03:45.900 |  |  |  | 29520-156a10 | INFO     | config.get_scheduler:_start_scheduler_as_leader:235 - 🎯 Worker 29520-156a10 持有 Application 锁，开始启动定时任务...
2026-07-15 08:03:47.158 |  |  |  | 29520-156a10 | INFO     | logging:callHandlers:1737 - Scheduler started
2026-07-15 08:03:47.964 |  |  |  | 29520-156a10 | ERROR    | config.get_scheduler:_add_job_to_scheduler:726 - ❌ 添加任务 遥测归档月分区维护 失败: 'No such job store: DEFAULT'
2026-07-15 08:03:47.976 |  |  |  | 29520-156a10 | INFO     | config.get_scheduler:_start_scheduler_as_leader:261 - ✅️ 系统初始定时任务加载成功
