...
├── telemetry/
│   ├── table/index.vue             # 遥测表（按数据类型复用）
│   ├── curve/index.vue             # 遥测曲线（热数据）
│   └── archive/index.vue           # 归档曲线（MySQL）
├── board/
│   ├── camera/index.vue            # 相机测试
│   ├── XlBoardPage.vue             # 热控电机 / CPA-ZK 共用页
│   ├── rkdj/index.vue / zk/index.vue
├── debug/
│   ├── simulate/index.vue          # 数据模拟（通用管道 + CAN 注入）
│   ├── xfer/index.vue              # 数据收发
│   └── config/index.vue
├── lvds/
