...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '成都总公司',   0, '我叫测试', '15888888888', 'test@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '杭州分公司', 1, '我叫测试', '15888888888', 'test@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '我叫测试', '15888888888', 'test@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   2, '我叫测试', '15888888888', 'test@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
insert into sys_user values(2,  105, 'test', '我叫测试', 			'00', 'test@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('106',  '参数设置', '1',   '7', 'config',              'system/config/index',               '', 'SystemConfig', 1, 0, 'C', '0', '0', 'system:config:list',               'edit',          'admin', sysdate(), '', null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告', '1',   '8', 'notice',              'system/notice/index',               '', '', 1, 0, 'C', '0', '0', 'system:notice:list',               'message',       'admin', sysdate(), '', null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理', '1',   '9', 'log',                 '',                                  '', '', 1, 0, 'M', '0', '0', '',                                 'log',           'admin', sysdate(), '', null, '日志管理菜单');
insert into sys_menu values('109',  '在线用户', '2',   '1', 'online',              'monitor/online/index',              '', '', 1, 0, 'C', '0', '0', 'monitor:online:list',              'online',        'admin', sysdate(), '', null, '在线用户菜单');
insert into sys_menu values('110',  '定时任务', '2',   '2', 'job',                 'monitor/job/index',                 '', '', 1, 0, 'C', '0', '0', 'monitor:job:list',                 'job',           'admin', sysdate(), '', null, '定时任务菜单');
insert into sys_menu values('112',  '服务监控', '2',   '3', 'server',              'monitor/server/index',              '', '', 1, 0, 'C', '0', '0', 'monitor:server:list',              'server',        'admin', sysdate(), '', null, '服务监控菜单');
insert into sys_menu values('113',  '缓存监控', '2',   '4', 'cache',               'monitor/cache/index',               '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',               'redis',         'admin', sysdate(), '', null, '缓存监控菜单');
insert into sys_menu values('114',  '缓存列表', '2',   '5', 'cacheList',           'monitor/cache/list',                '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',               'redis-list',    'admin', sysdate(), '', null, '缓存列表菜单');
insert into sys_menu values('120',  '传输加密', '2',   '6', 'transportCrypto',     'monitor/transportCrypto/index',     '', '', 1, 0, 'C', '0', '0', 'monitor:transportCrypto:list',     'chart',         'admin', sysdate(), '', null, '传输加密监控菜单');
...
insert into sys_menu values('2100', '遥测',   '0', '6', 'telemetry',   null, '', '', 1, 0, 'M', '0', '0', '', 'chart',     'admin', sysdate(), '', null, '遥测目录');
insert into sys_menu values('2200', '单板',   '0', '7', 'board',       null, '', '', 1, 0, 'M', '0', '0', '', 'component', 'admin', sysdate(), '', null, '单板目录');
...
insert into sys_menu values('2110', '实时数据', '2100', '1', 'live', 'payload/telemetry/table/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:view', 'table', 'admin', sysdate(), '', null, '实时遥测表（全量表）');
insert into sys_menu values('2108', '实时曲线', '2100', '2', 'curve', 'payload/telemetry/curve/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:curve', 'chart', 'admin', sysdate(), '', null, '实时遥测曲线页');
insert into sys_menu values('2112', '历史CAN数据', '2100', '3', 'canHistory', 'payload/telemetry/canHistory/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:canHistory', 'table', 'admin', sysdate(), '', null, '历史CAN遥测表回放');
insert into sys_menu values('2109', '历史CAN曲线', '2100', '4', 'archive', 'payload/telemetry/archive/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:archive', 'documentation', 'admin', sysdate(), '', null, '历史CAN归档曲线页');
insert into sys_menu values('2113', '历史文件数据', '2100', '5', 'fileHistory', 'payload/telemetry/fileHistory/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:fileHistory', 'table', 'admin', sysdate(), '', null, '历史文件遥测表回放');
insert into sys_menu values('2114', '历史文件曲线', '2100', '6', 'fileCurve', 'payload/telemetry/fileCurve/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:fileCurve', 'chart', 'admin', sysdate(), '', null, '历史文件遥测曲线');
insert into sys_menu values('2201', '相机v1.6', '2200', '1', 'camera', 'payload/board/camera/index', '', '', 1, 0, 'C', '0', '0', 'payload:camera:view', 'eye', 'admin', sysdate(), '', null, '相机 SC-LINK41EP V1.6');
insert into sys_menu values('2205', '相机v1.7', '2200', '2', 'camera_v17', 'payload/board/camera_v17/index', '', '', 1, 0, 'C', '0', '0', 'payload:camera_v17:view', 'eye', 'admin', sysdate(), '', null, '相机 SC-LINK41EP V1.7');
insert into sys_menu values('2202', '热控电机', '2200', '3', 'rkdj', 'payload/board/rkdj/index', '', '', 1, 0, 'C', '0', '0', 'payload:rkdj:view', 'server', 'admin', sysdate(), '', null, '热控电机单板');
insert into sys_menu values('2203', 'CPA-ZK', '2200', '4', 'zk', 'payload/board/zk/index', '', '', 1, 0, 'C', '0', '0', 'payload:zk:view', 'monitor', 'admin', sysdate(), '', null, 'CPA-ZK单板');
insert into sys_menu values('2204', '地检板', '2200', '5', 'dj', 'payload/board/dj/index', '', '', 1, 0, 'C', '0', '0', 'payload:dj:view', 'monitor', 'admin', sysdate(), '', null, '地检板 UDP（表格4工程遥测）');
insert into sys_menu values('2206', 'CPA指向', '2200', '6', 'cpazx', 'payload/board/cpazx/index', '', '', 1, 0, 'C', '0', '0', 'payload:cpazx:view', 'monitor', 'admin', sysdate(), '', null, 'CPA指向单板（协议V1.0，RS422 921600 8N1）');
...
insert into sys_menu values('2503', '配置文件', '2500', '3', 'configFile', 'payload/debug/config/index', '', 'PayloadConfigFile', 1, 0, 'C', '0', '0', 'payload:configfile:view', 'documentation', 'admin', sysdate(), '', null, '遥控遥测配置文件管理');
insert into sys_menu values('2504', '遥测计算', '2500', '4', 'tmCalc', 'payload/debug/tmCalc/index', '', '', 1, 0, 'C', '0', '0', 'payload:tmcalc:view', 'edit', 'admin', sysdate(), '', null, '遥测单字段 Hex 解析计算调试');
insert into sys_menu values('2531', '配置编辑', '2503', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'payload:configfile:edit', '#', 'admin', sysdate(), '', null, '');
