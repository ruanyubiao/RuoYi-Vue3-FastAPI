...
insert into sys_menu values('2503', '配置文件', '2500', '3', 'config', 'payload/debug/config/index', '', '', 1, 0, 'C', '0', '0', 'payload:configfile:view', 'documentation', 'admin', sysdate(), '', null, '遥控遥测配置文件管理');
