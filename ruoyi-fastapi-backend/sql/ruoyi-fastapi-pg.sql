...
insert into sys_menu values(2104, '0xF9：B-4-1指向标校包',   2100, '4', 'tmF9', 'payload/telemetry/table/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:view', 'table', 'admin', current_timestamp, '', null, '');
insert into sys_menu values(2105, '0xF7：B-4-2星敏遥测包',   2100, '5', 'tmF7', 'payload/telemetry/table/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:view', 'table', 'admin', current_timestamp, '', null, '');
