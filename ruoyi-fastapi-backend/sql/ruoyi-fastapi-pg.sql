...
insert into sys_menu values(2004, '开发测试', 2000, '4', 'devtest',  'payload/telecontrol/devtest/index',  '', '', 1, 0, 'C', '0', '0', 'payload:devtest:view',     'bug',    'admin', current_timestamp, '', null, '开发测试页');
