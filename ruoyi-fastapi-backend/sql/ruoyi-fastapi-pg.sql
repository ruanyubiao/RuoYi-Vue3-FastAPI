...
insert into sys_menu values(2100, '遥测',   0, '6', 'telemetry',   null, '', '', 1, 0, 'M', '0', '0', '', 'chart',     'admin', current_timestamp, '', null, '遥测目录');
insert into sys_menu values(2200, '单板',   0, '7', 'board',       null, '', '', 1, 0, 'M', '0', '0', '', 'component', 'admin', current_timestamp, '', null, '单板目录');
...
insert into sys_menu values(2110, '实时数据', 2100, '1', 'live', 'payload/telemetry/table/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:view', 'table', 'admin', current_timestamp, '', null, '实时遥测表（全量表）');
insert into sys_menu values(2108, '实时曲线', 2100, '2', 'curve', 'payload/telemetry/curve/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:curve', 'chart', 'admin', current_timestamp, '', null, '实时遥测曲线页');
insert into sys_menu values(2112, '历史CAN数据', 2100, '3', 'canHistory', 'payload/telemetry/canHistory/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:canHistory', 'table', 'admin', current_timestamp, '', null, '历史CAN遥测表回放');
insert into sys_menu values(2109, '历史CAN曲线', 2100, '4', 'archive', 'payload/telemetry/archive/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:archive', 'documentation', 'admin', current_timestamp, '', null, '历史CAN归档曲线页');
insert into sys_menu values(2113, '历史文件数据', 2100, '5', 'fileHistory', 'payload/telemetry/fileHistory/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:fileHistory', 'table', 'admin', current_timestamp, '', null, '历史文件遥测表回放');
insert into sys_menu values(2114, '历史文件曲线', 2100, '6', 'fileCurve', 'payload/telemetry/fileCurve/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:fileCurve', 'chart', 'admin', current_timestamp, '', null, '历史文件遥测曲线');
insert into sys_menu values(2201, '相机v1.6', 2200, '1', 'camera', 'payload/board/camera/index', '', '', 1, 0, 'C', '0', '0', 'payload:camera:view', 'eye', 'admin', current_timestamp, '', null, '相机 SC-LINK41EP V1.6');
insert into sys_menu values(2205, '相机v1.7', 2200, '2', 'camera_v17', 'payload/board/camera_v17/index', '', '', 1, 0, 'C', '0', '0', 'payload:camera_v17:view', 'eye', 'admin', current_timestamp, '', null, '相机 SC-LINK41EP V1.7');
insert into sys_menu values(2202, '热控电机', 2200, '3', 'rkdj', 'payload/board/rkdj/index', '', '', 1, 0, 'C', '0', '0', 'payload:rkdj:view', 'server', 'admin', current_timestamp, '', null, '热控电机单板');
insert into sys_menu values(2203, 'CPA-ZK', 2200, '4', 'zk', 'payload/board/zk/index', '', '', 1, 0, 'C', '0', '0', 'payload:zk:view', 'monitor', 'admin', current_timestamp, '', null, 'CPA-ZK单板');
insert into sys_menu values(2204, '地检板', 2200, '5', 'dj', 'payload/board/dj/index', '', '', 1, 0, 'C', '0', '0', 'payload:dj:view', 'monitor', 'admin', current_timestamp, '', null, '地检板 UDP（表格4工程遥测）');
insert into sys_menu values(2206, 'CPA指向', 2200, '6', 'cpazx', 'payload/board/cpazx/index', '', '', 1, 0, 'C', '0', '0', 'payload:cpazx:view', 'monitor', 'admin', current_timestamp, '', null, 'CPA指向单板（协议V1.0，RS422 921600 8N1）');
...
insert into sys_menu values(2504, '遥测计算', 2500, '4', 'tmCalc', 'payload/debug/tmCalc/index', '', '', 1, 0, 'C', '0', '0', 'payload:tmcalc:view', 'edit', 'admin', current_timestamp, '', null, '遥测单字段 Hex 解析计算调试');
