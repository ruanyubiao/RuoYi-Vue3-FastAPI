...
insert into sys_menu values(2201, '相机测试', 2200, '1', 'camera', 'payload/board/camera/index', '', '', 1, 0, 'C', '0', '0', 'payload:camera:view', 'eye', 'admin', current_timestamp, '', null, '相机测试');
insert into sys_menu values(2202, '热控电机', 2200, '2', 'rkdj', 'payload/board/rkdj/index', '', '', 1, 0, 'C', '0', '0', 'payload:rkdj:view', 'server', 'admin', current_timestamp, '', null, '热控电机单板');
insert into sys_menu values(2203, 'CPA-ZK', 2200, '3', 'zk', 'payload/board/zk/index', '', '', 1, 0, 'C', '0', '0', 'payload:zk:view', 'monitor', 'admin', current_timestamp, '', null, 'CPA-ZK单板');
insert into sys_menu values(2204, '地检板', 2200, '4', 'dj', 'payload/board/dj/index', '', '', 1, 0, 'C', '0', '0', 'payload:dj:view', 'monitor', 'admin', current_timestamp, '', null, '地检板 UDP（表格4工程遥测）');
