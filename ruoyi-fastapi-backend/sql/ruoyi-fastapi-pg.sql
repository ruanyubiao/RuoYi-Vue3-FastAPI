...
insert into sys_menu values(2110, '遥测表-BIU', 2100, '1', 'tableBiu', 'payload/telemetry/table/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:view', 'table', 'admin', current_timestamp, '', null, '遥测表-BIU');
insert into sys_menu values(2111, '遥测表-XL',  2100, '2', 'tableXl',  'payload/telemetry/table/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:view', 'table', 'admin', current_timestamp, '', null, '遥测表-XL');
insert into sys_menu values(2108, '遥测曲线', 2100, '3', 'curve', 'payload/telemetry/curve/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:curve', 'chart', 'admin', current_timestamp, '', null, '遥测曲线页');
insert into sys_menu values(2109, '遥测归档数据', 2100, '4', 'archive', 'payload/telemetry/archive/index', '', '', 1, 0, 'C', '0', '0', 'payload:telemetry:archive', 'documentation', 'admin', current_timestamp, '', null, '遥测归档曲线页');
